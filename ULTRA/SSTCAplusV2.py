...
def label_dependence_K_yy_star(y, U, gamma):
    M_total = len(y)
...
def SSTCAplusV2(X, y, L_s, L_d, U, components, k, sigma, lamda, kernel = "linear",
    ...
    Kyy_star = label_dependence_K_yy_star(y, U, gamma)
